...
const _require2 = require(`./error-helpers`),
      sanitizeErrors = _require2.sanitizeErrors;
...
const _require4 = require(`child_process`),
      execSync = _require4.execSync;
...
module.exports = class AnalyticsTracker {
  ...
  getGatsbyCliVersion() {
    try {
      ...
      const version = require(jsonfile).version.version;
