...
const _require2 = require(`valid-url`),
      isWebUri = _require2.isWebUri;
...
const _require4 = require(`./create-file-node`),
      createFileNode = _require4.createFileNode;

const _require5 = require(`./utils`),
      getRemoteFileExtension = _require5.getRemoteFileExtension,
      getRemoteFileName = _require5.getRemoteFileName;
